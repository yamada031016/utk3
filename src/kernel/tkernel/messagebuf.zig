...
// const MBFCB = struct {
//  send_queue: QUEUE,	// Message buffer send wait queue */
// 	mbfid: ID,		// message buffer ID */
// 	exinf: *void,		// Extended information */
// 	mbfatr: ATR,		// Message buffer attribute */
// 	recv_queue: QUEUE,	// Message buffer receive wait queue */
// 	bufsz: i32,		// Message buffer size */
// 	maxmsz: isize,		// Maximum length of message */
// 	frbufsz: i32,	// Free buffer size */
// 	head: i32,		// First message store address */
// 	tail: i32,		// Next to the last message store address */
// 	buffer: *i8,	// Message buffer address */
// // if (comptime USE_OBJECT_NAME) {
// //          name: [OBJECT_NAME_LENGTH]const u8,	// name */
// //      }
// };
//
// pub const  knl_mbfcb_table: []MBFCB = undefined;	// Message buffer control block */
...
// inline fn knl_mbf_free( mbfcb: *MBFCB, msgsz: isize ) bool {
// 	return ( HEADERSZ + @as(u32,msgsz) <= @as(u32,mbfcb).frbufsz );
// }
//
// // * If message buffer is empty, return TRUE.
// inline fn knl_mbf_empty(  mbfcb: *MBFCB ) bool {

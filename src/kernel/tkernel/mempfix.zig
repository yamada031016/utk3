...
// 	mpfid: ID,		// Fixed size memory pool ID */
// 	exinf: *void,		// Extended information */
// 	mpfatr: ATR,		// Memory pool attribute */
// 	mpfcnt: i32,		// Number of blocks in whole memory pool */
// 	blfsz: i32,		// Fixed size memory block size */
// 	mpfsz: i32,		// Whole memory pool size */
// 	frbcnt: i32,		// Number of blocks in free area */
// 	mempool: *void,	// Top address of memory pool */
// 	unused: *void,		// Top address of unused area */
// 	freelist: *FREEL,	// Free block list */
// 	lock: OBJLOCK,		// Lock for object exclusive access */

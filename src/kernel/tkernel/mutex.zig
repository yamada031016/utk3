...
// const MTXCB = struct {
//  wait_queue: QUEUE,	// Mutex wait queue */
// 	mtxid: ID,		// Mutex ID */
// 	exinf: *void,		// Extended information */
// 	mtxatr: ATR,		// Mutex attribute */
// 	ceilpri: u8,	// Highest priority limit of mutex */
// 	mtxtsk: *TCB,	// Mutex get task */
// 	mtxlist: *MTXCB,	// Mutex get list */
// // if (comptime USE_OBJECT_NAME) {
// //          name: [OBJECT_NAME_LENGTH]const u8,	// name */
// //      }
// };
//
// pub const knl_mtxcb_table: []MTXCB=undefined;	// Mutex control block */

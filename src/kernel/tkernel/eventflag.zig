...
//      wait_queue: QUEUE,	// Event flag wait queue */
//      flgid: ID,		// Event flag ID */
//      exinf: *void,		// Extended information */
//      flgatr: ATR,		// Event flag attribute */
//      flgptn: usize,		// Event flag current pattern */
...
// inline fn knl_eventflag_cond( flgcb: *FLGCB, waiptn: usize, wfmode: usize ) bool {
// 	if ( (wfmode & TWF_ORW) != 0 ) {

...
//
// const MPLCB = struct  {
//  wait_queue: QUEUE,	// Memory pool wait queue */
//  mplid: ID,		// Variable size memory pool ID */
// 	exinf: *void,		// Extended information */
// 	mplatr: ATR,		// Memory pool attribute */
// 	mplsz: i32,		// Whole memory pool size */
// 	areaque: QUEUE,	// Queue connecting all blocks */
// 	freeque: QUEUE,	// Queue connecting free blocks */
// 	areaque_end: QUEUE,	// the last element of areaque */
// 	mempool: *void,	// Top address of memory pool */
// // if (comptime USE_OBJECT_NAME){
// //      name: [OBJECT_NAME_LENGTH]const u8,	// name */
// // }
// };
//
// pub const  knl_mplcb_table: []MPLCB = undefined;	// Variable size memory pool control block */
...
//
// inline fn knl_MaxFreeSize( mplcb: *MPLCB ) QueError!i32 {
// 	if ( isQueEmpty(&mplcb.freeque) ) {
// 		return QueError.Empty;
// 	}

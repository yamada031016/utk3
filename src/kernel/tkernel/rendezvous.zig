...
// if (comptime USE_LEGACY_API) {
// * Rendezvous port control block
// const PORCB = struct  {
//  call_queue: QUEUE,	// Port call wait queue */
//  porid: ID,		// Port ID */
//  exinf: *void,		// Extended information */
//  poratr: ATR,		// Port attribute */
//  accept_queue:QUEUE,	// Port accept wait queue */
//  maxcmsz: isize,	// Maximum length of call message */
